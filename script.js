                        ...
                        <div class="quiz-container" id="simple-quiz">
                            <div class="quiz-question" data-question="1">
                                ...
                                <div class="quiz-options">
                                    <div class="quiz-option" onclick="selectQuizOption(this, false)" data-correct="false">A) Baseball cap</div>
                                    <div class="quiz-option" onclick="selectQuizOption(this, true)" data-correct="true">B) Safety glasses</div>
                                    <div class="quiz-option" onclick="selectQuizOption(this, false)" data-correct="false">C) Headphones</div>
                                </div>
                            </div>
                            ...
                            <div class="quiz-question" data-question="2">
                                ...
                                <div class="quiz-options">
                                    <div class="quiz-option" onclick="selectQuizOption(this, false)" data-correct="false">A) Leave it loose</div>
                                    <div class="quiz-option" onclick="selectQuizOption(this, true)" data-correct="true">B) Tie it back securely</div>
                                    <div class="quiz-option" onclick="selectQuizOption(this, false)" data-correct="false">C) Cover with a hat only</div>
                                </div>
                            </div>
